                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$adm->alamat}}</td>
                      <td>
                          <button type="button" class="btn btn-secondary btn-sm ubah" data-toggle="modal" data-target="#ubahModal"
                          data-id_admin="{{$adm->id_admin}}"
                          data-nama="{{$adm->nama}}"
                          data-email="{{$adm->email}}"
                          data-alamat="{{$adm->alamat}}"><i class="far fa-edit"></i>Ubah</button>

                          <a href="/hapusAdmin/{{$adm->id_admin}}" class="konfirmasi"><button type="button" class="btn btn-danger btn-sm" ><i class="fas fa-trash"></i>Hapus</button></a>
