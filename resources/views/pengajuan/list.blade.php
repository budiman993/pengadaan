                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="/terimaPengajuan/{{$p['id_pengajuan']}}" class="btn btn-success btn-sm konfirmasi"><i class="fa fa-check"></i> Terima</a>
                        <a href="/tolakPengajuan/{{$p['id_pengajuan']}}" class="btn btn-danger btn-sm konfirmasi"><i class="fas fa-times"></i> Tolak</a>
                        @endif
                      </td>
                    </tr>
                    @endforeach
