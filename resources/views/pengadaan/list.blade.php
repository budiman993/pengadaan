                ...
                <table style="text-align: center;" class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a target="_blank" href="{{$p->deskripsi}}"><button class="btn btn-primary btn-sm">Lihat Deskripsi</button></a></td>
                      <td style="width:15%;">

                      @if($p->gambar != "-")
                      <img style="width:70%;" src="{{asset(Storage::url($p->gambar))}}">
                      <hr>
                      <a href="/hapusGambar/{{$p->id_pengadaan}}" class="konfirmasi"><button class="btn-danger btn-sm"><i class="fas fa-trash"> Hapus</i></button></a>
                      @endif
                      ...
                      <td>
                        <a href="/hapusPengadaan/{{$p->id_pengadaan}}" class="konfirmasi"><button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i>Hapus</button>
                        </a>
                        ...
                        class="btn btn-secondary btn-sm ubah" data-toggle="modal" data-target="#ubahModal"><i class="fas fa-edit"></i>Ubah</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
